<div id="travelbreadcrumbar">
    ...
    if(!$alert)
        ...
        <span class="divider" style="margin-right: 10px;">
                <img src="components/com_travel/images/gufo.png" width="30" />
            You are working on:
        </span>
    <li><a href="usecase2.html">travel</a></li>';
    else
        $nav = '
        <ol class="breadcrumb big">
        <span class="divider" style="margin-right: 10px;">
                <img src="components/com_travel/images/gufo.png" width="50" />
            Return on travel :
        </span>
    <li>travel</li>';
    ...
    if($alert)
        $nav .= '<li><div id="alert">You are working on framework, to come back to travel click here!</div></li>';
...
?>
    <div id="exitbox">
        <input type="button" class="btn btn-primary btn-small " id="exitbtn" value="Exit travel">
    </div>
<?php
}
?>
...
<script type="application/javascript">
    jQuery(document).ready(function($){
        ...
        $("#exitbtn").click(function(){
            ...
            url = encodeURI(url);
            window.location.replace("index.php?option=com_travel&task=traveloff&url="+url);
