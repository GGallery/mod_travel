<?php
//$corsiabilitati = modtravelHelper::getCorsi();
if($corsiabilitati[0])

{
	...
	foreach($corsiabilitati as $corsoabilitato)
	{
		...
		echo '<li><a class="indice_corsi" title="'.$title.'" href="index.php/component/travel/corso/'.$corsoabilitato['alias'].'.html" >'.$corsoabilitato['corso'].'</a>
